<?php
    ...
    $school_name        =       "Riverdale / Kingsbridge Academy (Middle School / High School 141)";
    // $website_url        =       "http://localhost/calessons.com/10x141"; // LOCALHOST
    $website_url        =       "https://10x141.calessons.com";
