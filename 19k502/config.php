<?php
    ...
    $school_name        =       "FDNY - Captain Vernon A. Richard High School for Fire and Life Safety";
    // $website_url        =       "http://localhost/calessons.com/19k502"; // LOCALHOST
    $website_url        =       "https://19k502.calessons.com";
