<?php
    ...
    $school_name        =       "The East New York Arts and Civics High School";
    // $website_url        =       "http://localhost/calessons.com/19k953"; // LOCALHOST
    $website_url        =       "https://19k953.calessons.com";
