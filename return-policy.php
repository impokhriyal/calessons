...
<head>
    ...
    <title>Return Policy - <?php echo $website_name; ?></title>
...
<body>
    ...
    <div class="ca-wrapper">
        <main id="main-body" class="col content scroll-container">
            ...
            <article>
                <section class="header sub-banner has-bg refund-policy-banner bg-primary-overlay-8 text-center lazyload">
                    <div class="container">
                        <h1 tabindex="0" itemprop="about" class="head wow animate__fadeInUp m-0">Return Policy</h1>
                    </div>
                </section>

                <section class="ca-logo-anim pb-5 pb-md-9" style="min-height:67%;">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-9">
                                <h2 class="h4 mb-4">Lisa G. Flowers, M.A., C.C.C. - S.L.P.</h2>

                                <p>You may return new board games purchased from Communication Acceleration within 30 days of delivery for a refund of the game's cost, minus the shipping and handling fee and a 15% restocking fee, provided they are in resaleable condition.</p>

                                <p>Communication Acceleration is owned and operated by:</p>
                                <p><strong>Creative Media Spark Inc.</strong><br />68B Mackey Avenue<br />First Floor<br />Port Washington, New York, 11050</p>
                            </div>
                        </div>
                    </div>
                </section>
