<?php
    ...
    $school_name        =       "The Laboratory School of Finance and Technology: X223";
    // $website_url        =       "http://localhost/calessons.com/07x223"; // LOCALHOST
    $website_url        =       "https://07x223.calessons.com";
