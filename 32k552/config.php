<?php
    ...
    $school_name        =       "The Academy of Urban Planning and Engineering";
    // $website_url        =       "http://localhost/calessons.com/32k552"; // LOCALHOST
    $website_url        =       "https://32k552.calessons.com";
