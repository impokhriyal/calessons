<?php
    ...
    $school_name        =       "Archimedes Academy for Math, Science and Technology Applications";
    // $website_url        =       "http://localhost/calessons.com/08x367"; // LOCALHOST
    $website_url        =       "https://08x367.calessons.com";
