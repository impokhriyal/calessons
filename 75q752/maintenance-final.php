...
<body>
	...
	<main>
		<section class="position-relative d-flex align-items-center py-7">
			<figure class="position-absolute start-0 bottom-0 m-5 d-none d-lg-block">
				<svg width="214" height="173" viewBox="0 0 358 287" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="position-absolute end-0 top-0 z-index-9 m-5 d-none d-lg-block">
				<img src="<?php echo $assets_url; ?>/assets/img/img-placeholder.png" data-src="<?php echo $assets_url; ?>/assets/img/social-emotional-learning.png" width="140" height="140" class="lazyload wow animate__bounceIn" />
			</div>
			<?php /*
			<figure class="position-absolute end-0 top-0 z-index-9 m-5 d-none d-lg-block">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 mx-auto text-center">
						<h1 class="display-5 text-dark-stroke text-primary-shadow">We Will Be Right Back!</h1>
						<p class="lead">52 Lessons for 52 Weeks</p>
					</div>
				</div>
				...
				<div class="row justify-content-center">
					<div class="col-md-8">
						<div itemscope itemtype="https://schema.org/VideoObject" class="position-relative rounded-0 overflow-hidden lh-none mb-2">
							<meta itemprop="name" content="S.L.P. Lisa Flowers' 52 Lessons for 52 weeks, at less than a dollar a week, it will make your year!" />
		...
		<section class="bg-primary text-white pt-5" style="min-height:64vh !important;">
			<div class="container text-center">
				<form class="form-primary form-line" id="subscriptionForm" action="includes/subscription-action.php" method="POST" novalidate="novalidate">
					<h3 class="form-label text-white fw-light">Want to get notified when we're back?</h3>
					<div class="row justify-content-center">
						<div class="col-md-8 my-3">
							<div id="mail-status"></div>
						</div>
					</div>
					<div id="subs_form" class="row justify-content-center mt-3">
						<div class="col-md-3 text-center text-md-start mt-4 mt-md-0">
							<input type="text" id="ftw_name" name="ftw_name" placeholder="Enter name..." class="form-control">
						</div>
						<div class="col-md-3 text-center text-md-start mt-4 mt-md-0">
							<input type="email" id="ftw_email" name="ftw_email" placeholder="Enter email..." class="form-control">
						</div>
						<div class="col-md-2 text-center text-md-start mt-4 mt-md-0">
							<button type="submit" value="Subscribe" class="btn btn-success fw-bold text-white w-100 mx-auto">Notify me!</button>
						</div>
						...
						<div class="col-md-8 mt-4 text-center small">
							<p>We are currently performing necessary maintenance on our website to improve your experience while browsing and purchasing our middle school and high school Language Arts and Social Skills worksheets and activities by Lisa G. Flowers, M.A., C.C.C. - S.L.P. We apologize for any inconvenience this may cause and appreciate your understanding.</p>
							<p>If you have any urgent inquiries or require immediate assistance, please feel free to contact us at <strong>info@52worksheets.com</strong>.</p>
						</div>
					</div>
				</form>
			</div>
...
<script type="text/javascript" defer>
    $(document).ready(function (e) {
        $("#subscriptionForm").on('submit', (function(e) {
            ...
            $('#loader-icon').show();
            $.ajax({
                url: "<?php echo $website_url; ?>/includes/subscription-action.php",
                type: "POST",
                dataType: 'json',
                data: {
                    "name": $('input[name="ftw_name"]').val(),
                    "email": $('input[name="ftw_email"]').val(),
