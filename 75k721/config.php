<?php
    ...
    $school_name        =       "P.S. K721 - Brooklyn Occupational Training Center";
    // $website_url        =       "http://localhost/calessons.com/75k721"; // LOCALHOST
    $website_url        =       "https://75k721.calessons.com";
