<?php
    ...
    $school_name        =       "The Eagle Academy for Young Men of Staten Island";
    // $website_url        =       "http://localhost/calessons.com/31r028"; // LOCALHOST
    $website_url        =       "https://31r028.calessons.com";
