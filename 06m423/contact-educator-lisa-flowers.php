                        ...
                        <div class="row g-0 justify-content-lg-between">
                            <div class="col-md-6 bg-transparent-start z-index-m9 position-relative h-100 d-flex align-items-center z-index-9">
                                <div class="position-relative w-100 py-5 pe-0 pe-md-6">
                                    ...
                                    <form class="contact-form form-primary form-line" id="contactCA" action="" method="POST" novalidate="novalidate">
                                        <div id="contact_form">
                                            <div class="mb-4">
                                                <label class="visually-hidden">Name</label>
                                                <input type="text" id="name" name="name" placeholder="Enter your name" value="" class="form-control" />
                                            </div>
                                            <div class="mb-4">
                                                <label class="visually-hidden">Email</label>
                                                <input type="text" id="email" name="email" placeholder="Enter your email" value="" class="form-control" />
                                            </div>
                                            <div class="mb-4">
                                                <label class="visually-hidden">Phone</label>
                                                <input type="text" id="phone" name="phone" placeholder="Enter your phone number" value="" class="form-control" />
                                            </div>
                                            <div class="mb-4">
