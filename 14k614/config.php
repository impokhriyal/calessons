<?php
    ...
    $school_name        =       "Young Women's Leadership School of Brooklyn";
    // $website_url        =       "http://localhost/calessons.com/14k614"; // LOCALHOST
    $website_url        =       "https://14k614.calessons.com";
