<?php
    ...
    $school_name        =       "The Urban Assembly Bronx Academy of Letters";
    // $website_url        =       "http://localhost/calessons.com/07x551"; // LOCALHOST
    $website_url        =       "https://07x551.calessons.com";
