<?php
    ...
    $school_name        =       "English Language Learners and International Support Preparatory Academy (ELLIS)";
    // $website_url        =       "http://localhost/calessons.com/10x397"; // LOCALHOST
    $website_url        =       "https://10x397.calessons.com";
