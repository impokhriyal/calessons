<?php
    ...
    $school_name        =       "P.S. M721 - Manhattan Occupational Training Center";
    // $website_url        =       "http://localhost/calessons.com/75m721"; // LOCALHOST
    $website_url        =       "https://75m721.calessons.com";
