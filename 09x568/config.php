<?php
    ...
    $school_name        =       "Young Women's Leadership School of the Bronx";
    // $website_url        =       "http://localhost/calessons.com/09x568"; // LOCALHOST
    $website_url        =       "https://09x568.calessons.com";
