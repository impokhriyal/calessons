<?php
    ...
    $school_name        =       "P469X - The Bronx School for Continuous Learners";
    // $website_url        =       "http://localhost/calessons.com/75x469"; // LOCALHOST
    $website_url        =       "https://75x469.calessons.com";
